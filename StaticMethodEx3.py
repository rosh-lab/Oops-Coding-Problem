...
h=Hyd()
h.dispobjinfo(eo,"Employee") #calling static method by using object name
h.dispobjinfo(so,"Student") ##calling static method by using object name
h.dispobjinfo(to,"Teacher") #calling static method by using object name