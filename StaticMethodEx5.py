...
class Hyd:
    @classmethod
    def recvobject(cls,obj,objinfo):
        cls.dispobjinfo(obj,objinfo) #Calling static method from class level method w.r.t cls
    @staticmethod
...
Hyd.recvobject(eo,"Employee") #calling class level method by using class name
Hyd.dispobjinfo(so,"Student") #calling class level method by using class name
Hyd.dispobjinfo(to,"Teacher") #calling class level method by using class name