...
class Hyd:
    def recvobject(self,obj,objinfo): #Instance method
        self.dispobjinfo(obj,objinfo) #Calling static method from instance method w.r.t self
    @staticmethod
...
Hyd().recvobject(eo,"Employee") #calling instance method by using name less object
Hyd().dispobjinfo(so,"Student") #calling instance method by using name less object
Hyd().dispobjinfo(to,"Teacher") #calling instance method by using name less object